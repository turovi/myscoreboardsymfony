 ...
 */
final class Version20220324153221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contest (id INT AUTO_INCREMENT NOT NULL, game_id_id INT NOT NULL, winner_id INT DEFAULT NULL, start_date DATE NOT NULL, INDEX IDX_1A95CB54D77E7D8 (game_id_id), INDEX IDX_1A95CB55DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
